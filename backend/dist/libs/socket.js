 ...
 */
export const emitNewMessage = (io, conversationId, message, receiverIds // <--- THÊM THAM SỐ NÀY
) => {
 ...
 */
export const emitMessageUpdated = (io, conversationId, message, receiverIds // <--- THÊM
) => {
    receiverIds.forEach(userId => {
 ...
 */
export const emitMessageRecalled = (io, conversationId, messageId, receiverIds // <--- THÊM
) => {
    receiverIds.forEach(userId => {
 ...
 */
export const emitConversationUpdated = (io, conversationId, conversation) => {
 ...
 */
export const emitFriendRequestCancelled = (io, requestId, receiverId) => {
    io.to(receiverId).emit("friend-request-cancelled", { requestId });
};
/**
 * Helper: Emit friend request declined event
 */
export const emitFriendRequestDeclined = (io, requestId, senderId) => {
    io.to(senderId).emit("friend-request-declined", { requestId });
};
/**
 * Helper: Emit friend request accepted event
 */
export const emitFriendRequestAccepted = (io, requestId, senderId, receiverId) => {
 ...
 */
export const emitNewConversation = (io, conversation, participantIds) => {
